...
func main() {
	...
	*/
	...
	keyWordList:=[]string{"苹果手机壳","吸顶灯","吊灯","筒灯","射灯","台灯","落地灯","室外灯","壁灯","小夜灯","智能马桶","智能马桶盖","智能车机","智能后视镜","充电器","路由器","充电宝","智能穿戴","蓝牙耳机","手机壳套","保护壳套","儿童手表","智能手表","智能手环","智能配饰","智能排插","智能眼镜","路由器","网络存储设备","路由器","耳机","U盘","闪存卡","记忆棒","移动硬盘","电磁炉","电水壶","料理机","电饭煲","榨汁机","净水器","豆浆机","烤箱","电风扇","空调扇","挂烫机","扫地机","吸尘器","加湿器","除湿机","对讲机","空气净化","理发器","电子称","美容仪","按摩椅","按摩披肩","血压计","足浴器","电动牙刷","剃须刀","耳机","音响","麦克风","扩音器","低音炮","打印机","投影仪","保险柜","学习机","冰箱","空调","平板电视","油烟机","燃气灶","消毒柜","热水器","洗衣机","智能钢琴","跑步机","早教机","游戏手柄","蓝牙耳机"}
	t1:=time.Now()
